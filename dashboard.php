...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="card">
            ...
            <<?php require_once 'includes/header.php'; ?> <?php 
...
?> <style type="text/css">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="panel panel-default">
                            <div class="panel-heading"> <i class="glyphicon glyphicon-calendar"></i> User Wise Order
                            </div>
                ...
                <?php require_once 'includes/footer.php'; ?>div class="cardContainer">
                <p> Total Revenue</p>
        </div>
    </div>
