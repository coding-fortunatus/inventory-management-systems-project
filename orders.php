    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
                ...
                <tbody>
                    ...
                    <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                        <td style="margin-left:20px;">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="productName[]" id="productName<?php echo $x; ?>"
                                    ...
                                    <?php
			  							$productSql = "SELECT * FROM product WHERE active = 1 
                        ...
                        <td style="padding-left:20px;">
                            <input type="text" name="rate[]" id="rate<?php echo number_format($x); ?>"
                                autocomplete="off" disabled="true" class="form-control" />
                            <input type="hidden" name="rateValue[]" id="rateValue<?php echo number_format($x); ?>"
                                autocomplete="off" class="form-control" />
                        </td>
                        <td style="padding-left:20px;">
                            <div class="form-group">
                                <p id="available_quantity<?php echo number_format($x); ?>"></p>
                            </div>
                        </td>
                        <td style="padding-left:20px;">
                            <div class="form-group">
                                <input type="number" name="quantity[]" id="quantity<?php echo number_format($x); ?>"
                                    onkeyup="getTotal(<?php echo number_format($x) ?>)" autocomplete="off"
                                    class="form-control" min="1" />
                            </div>
                        </td>
                        <td style="padding-left:20px;">
                            <input type="text" name="total[]" id="total<?php echo number_format($x); ?>"
                                autocomplete="off" class="form-control" disabled="true" />
                            <input type="hidden" name="totalValue[]" id="totalValue<?php echo number_format($x); ?>"
                                autocomplete="off" class="form-control" />
                        </td>
                        <td>
            ...
            <div class="col-md-6">
                ...
                <!--/form-group-->
                <div class="form-group">
                    <label for="vat" class="col-sm-3 control-label gst">VAT 7.5%</label>
                    <div class="col-sm-9">
        ...
        <form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
                ...
                <tbody>
                    ...
                    <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                        ...
                        <td style="padding-left:20px;">
                            <input type="text" name="rate[]" id="rate<?php echo number_format($x); ?>"
                                autocomplete="off" disabled="true" class="form-control"
                                value="<?php echo number_format($orderItemData['rate']); ?>" />
                            <input type="hidden" name="rateValue[]" id="rateValue<?php echo number_format($x); ?>"
                                autocomplete="off" class="form-control"
                                value="<?php echo number_format($orderItemData['rate']); ?>" />
                        </td>
                            ...
                            <div class="form-group">
                                <?php
			  							...
			  							while($row = $productData->fetch_array()) {									 		
			  								$selected = "";
			  								if($row['product_id'] == $orderItemData['product_id']) { 
			  									echo "<p id='available_quantity".$row['product_id']."'>".number_format($row['quantity'])."</p>";
											}
			  								 else {
			  									$selected = "";
			  								}
                        ...
                        <td style="padding-left:20px;">
                            <div class="form-group">
                                <input type="number" name="quantity[]" id="quantity<?php echo number_format($x); ?>"
                                    onkeyup="getTotal(<?php echo number_format($x) ?>)" autocomplete="off"
                                    class="form-control" min="1"
                                    value="<?php echo number_format($orderItemData['quantity']); ?>" />
                            </div>
                        </td>
                        <td style="padding-left:20px;">
                            <input type="text" name="total[]" id="total<?php echo number_format($x); ?>"
                                autocomplete="off" class="form-control" disabled="true"
                                value="<?php echo number_format($orderItemData['total']); ?>" />
                            <input type="hidden" name="totalValue[]" id="totalValue<?php echo number_format($x); ?>"
                                autocomplete="off" class="form-control"
                                value="<?php echo number_format($orderItemData['total']); ?>" />
                        </td>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="subTotal" name="subTotal" disabled="true"
                            value="<?php echo number_format($data[4]) ?>" />
                        <input type="hidden" class="form-control" id="subTotalValue" name="subTotalValue"
                            value="<?php echo number_format($data[4]) ?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="totalAmount" name="totalAmount" disabled="true"
                            value="<?php echo number_format($data[6]) ?>" />
                        <input type="hidden" class="form-control" id="totalAmountValue" name="totalAmountValue"
                            value="<?php echo number_format($data[6]) ?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="discount" name="discount" onkeyup="discountFunc()"
                            autocomplete="off" value="<?php echo number_format($data[7]) ?>" />
                    </div>
                </div>
                <!--/form-group-->
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="grandTotal" name="grandTotal" disabled="true"
                            value="<?php echo number_format($data[8]) ?>" />
                        <input type="hidden" class="form-control" id="grandTotalValue" name="grandTotalValue"
                            value="<?php echo number_format($data[8]) ?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="vat"
                        class="col-sm-3 control-label gst"><?php if($data[13] == 2) {echo "VAT 7.5%";} else echo "VAT 7.5%"; ?></label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="vat" name="vat" disabled="true"
                            value="<?php echo number_format($data[5]) ?>" />
                        <input type="hidden" class="form-control" id="vatValue" name="vatValue"
                            value="<?php echo number_format($data[5]) ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="gstn" class="col-sm-3 control-label gst">V.A.T.IN</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="gstn" name="gstn"
                            value="<?php echo number_format($data[14]) ?>" />
                    </div>
                </div>
                <!--/form-group-->
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="paid" name="paid" autocomplete="off"
                            onkeyup="paidAmount()" value="<?php echo number_format($data[9]) ?>" />
                    </div>
                </div>
                <!--/form-group-->
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="due" name="due" disabled="true"
                            value="<?php echo number_format($data[10]) ?>" />
                        <input type="hidden" class="form-control" id="dueValue" name="dueValue"
                            value="<?php echo number_format($data[10]) ?>" />
                    </div>
                </div>
